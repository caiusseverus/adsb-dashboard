...
def extract_compact_row(payload: dict[str, Any], iid: int, ts: float) -> dict[str, Any]:
    ...
    return {
        ...
        "period_authority": _pick(ss.get("period_authority"), payload.get("period_authority")),
        "sync_authority": _pick(ss.get("sync_authority"), payload.get("sync_authority")),
        "phase_basis": _pick(ss.get("phase_basis"), payload.get("phase_basis")),
        "phase_absolute_available": _pick(ss.get("phase_absolute_available"), payload.get("phase_absolute_available")),
        "df11_base_alignment_score": _pick(ss.get("df11_base_alignment_score"), payload.get("df11_base_alignment_score")),
        "df11_refined_alignment_score": _pick(ss.get("df11_refined_alignment_score"), payload.get("df11_refined_alignment_score")),
        "df11_refined_better_than_base": _pick(ss.get("df11_refined_better_than_base"), payload.get("df11_refined_better_than_base")),
        "df11_refined_alignment_delta": _pick(ss.get("df11_refined_alignment_delta"), payload.get("df11_refined_alignment_delta")),
        "df11_refined_on_time_count": _pick(ss.get("df11_refined_on_time_count"), payload.get("df11_refined_on_time_count")),
        "df11_base_on_time_count": _pick(ss.get("df11_base_on_time_count"), payload.get("df11_base_on_time_count")),
        "df11_refined_residual_spread_deg": _pick(ss.get("df11_refined_residual_spread_deg"), payload.get("df11_refined_residual_spread_deg")),
        "df11_base_residual_spread_deg": _pick(ss.get("df11_base_residual_spread_deg"), payload.get("df11_base_residual_spread_deg")),
        "df11_verification_window_s": _pick(ss.get("df11_verification_window_s"), payload.get("df11_verification_window_s")),
        "df11_verification_sample_count": _pick(ss.get("df11_verification_sample_count"), payload.get("df11_verification_sample_count")),
        "df11_verification_reason": _pick(ss.get("df11_verification_reason"), payload.get("df11_verification_reason")),
        "df11_verification_state": _pick(ss.get("df11_verification_state"), payload.get("df11_verification_state")),
        "df11_verification_confidence": _pick(ss.get("df11_verification_confidence"), payload.get("df11_verification_confidence")),
        "df11_verification_blocker_if_enforced": _pick(ss.get("df11_verification_blocker_if_enforced"), payload.get("df11_verification_blocker_if_enforced")),
