...
class LiveSyncState:
    ...
    geographic_phase_calibrated: bool = False
    geographic_phase_offset_deg: float | None = None
    geographic_phase_offset_convention: str | None = None
    geographic_phase_source: str | None = None
    geographic_phase_calibrated_at_ts: float | None = None
    geographic_phase_valid_until_ts: float | None = None
    geographic_phase_max_age_s: float | None = None
    geographic_phase_confidence_operator: float | None = None
    geographic_phase_notes: str | None = None
    geographic_phase_location_lat: float | None = None
    geographic_phase_location_lon: float | None = None
    geographic_phase_receiver_id: str | None = None
    geographic_phase_receiver_source: str | None = None
    geographic_phase_status: str | None = None
    geographic_phase_invalid_reason: str | None = None
    geographic_phase_age_s: float | None = None
    localisation_safe_phase: bool = False
    localisation_safe_phase_reason: str | None = None
    underlying_phase_basis: str | None = None
    underlying_phase_authority: str | None = None
    ...
    holdover_entered_ts: float | None = None
    holdover_last_transition_ts: float | None = None
    ...
    go_operational_ready_streak: int = 0
    go_operational_promotion_threshold: int = 0
    go_operational_ready_streak_age_s: float | None = None
    go_operational_last_ready_ts: float | None = None
    go_operational_last_not_ready_ts: float | None = None
    go_operational_streak_reset_reason: str | None = None
    go_operational_streak_reset_gate: str | None = None
    go_operational_streak_reset_handoff_reason: str | None = None
    go_operational_soft_failure_active: bool = False
    go_operational_soft_failure_until_ts: float | None = None
    go_operational_soft_failure_remaining_s: float | None = None
    go_operational_soft_failure_reason: str | None = None
    go_operational_hysteresis_decision: str | None = None
