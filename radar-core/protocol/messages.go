...
type IIDState struct {
	...
	PeriodAuthority       string   `codec:"pauth"`
	SyncAuthority         string   `codec:"sauth"`
	PhaseBasis            string   `codec:"phb"`
	PhaseIsAbsolute       bool     `codec:"pia"`
	PeriodDeltaSource     string   `codec:"pdsrc"`
	FitObservationCount   uint16   `codec:"foc"`
	FitSpanS              *float64 `codec:"fss"`
	SlopeSignConvention   string   `codec:"ssc"`
	EffectivePeriodSource string   `codec:"epsrc"`
