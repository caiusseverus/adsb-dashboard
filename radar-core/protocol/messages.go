...
type IIDState struct {
	...
	LastUpdateEpochOutcome                   string   `codec:"ueou"`
	LastUpdateEpochCandidateEpochAgeS        *float64 `codec:"ueca"`
	PhaseOffsetCandidateRawDeg               *float64 `codec:"pocr"`
	PhaseOffsetCandidateWrappedDeg           *float64 `codec:"pocw"`
	PhaseOffsetBlendedDeg                    *float64 `codec:"pobd"`
	PhaseOffsetBlendDeltaDeg                 *float64 `codec:"podd"`
	PhaseOffsetDeltaBeforeBlendDeg           *float64 `codec:"podb"`
	PhaseOffsetDeltaAfterBlendDeg            *float64 `codec:"poda"`
	PhaseOffsetPreviousDeg                   *float64 `codec:"popr"`
	PhaseOffsetPreviousFitEpochDeg           *float64 `codec:"pofe"`
	...
	PhaseOffsetDiscontinuityOldDeg           *float64 `codec:"pdo"`
	PhaseOffsetDiscontinuityNewDeg           *float64 `codec:"pdn"`
	PhaseOffsetDiscontinuityDeltaDeg         *float64 `codec:"pdd"`
	PhaseOffsetDiscontinuityThresholdDeg     *float64 `codec:"pdt"`
	PhaseOffsetDiscontinuityFitEpochID       uint32   `codec:"pdf"`
	PhaseOffsetDiscontinuityCurrentEpochUS   *float64 `codec:"pdc"`
	PhaseOffsetDiscontinuityCandidateEpochUS *float64 `codec:"pdx"`
	PhaseOffsetDiscontinuityPreviousRefICAO  *uint32  `codec:"pdp"`
	...
	GoSyncUsableHoldoverOK                   bool     `codec:"gsuh"`
