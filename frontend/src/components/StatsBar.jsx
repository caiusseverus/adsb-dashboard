...
export default function StatsBar({ snapshot }) {
  ...
  return (
    <div className={styles.bar}>
      ...
      <StatCard label="Total Messages"   value={new Intl.NumberFormat(undefined, { notation: 'compact', maximumFractionDigits: 2 }).format(snapshot.total_messages ?? 0)} accent="green"  />
    </div>
  )
}
